...
import com.bucifer.lifeclock_english.R;
...
Context mContext;
    ...
    public AnalogClock1(Context context, AttributeSet attrs,
     ...
     //   if (mMinuteHand == null) {
            ...
            mSecondHand = r.getDrawable(R.drawable.clock_minute);
     //   }
...
//        mCalendar.setToNow();
    	...
    	int hour = Calculations.hourMark;
        int minute = Calculations.minuteMark;
        int second = 0;
