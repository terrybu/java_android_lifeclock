...
public class MainClock extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	final EditText ageInput = (EditText) findViewById(R.id.editText1); 
        
        Button b = (Button) findViewById(R.id.button1);
		final MediaPlayer mp = MediaPlayer.create (MainClock.this, R.raw.beep);
		
        b.setOnClickListener(new OnClickListener() {		
        	public void onClick(View v) {
				mp.start();
        		
				Intent intent = new Intent(MainClock.this, ResultPage.class);				
...
//							this above alert clicktype exits out of the application completely to the home screen
					...
					int p = Integer.parseInt(placeholder);
					if (p > 80 || p < 1){
						AlertDialog.Builder builder = new AlertDialog.Builder(MainClock.this);
						builder.setMessage(R.string.outofrange);
						builder.setCancelable(true);
						...
						intent.putExtra("theAge", placeholder);
